...
urlpatterns = [
    ...
    url(r'^quizzes/(?P<enrolled>\w+)/$',
        views.quizlist_user, name='quizlist_user'),
    ...
    url(r'^(?P<q_id>\d+)/skip/(?P<next_q>\d+)/(?P<attempt_num>\d+)/(?P<module_id>\d+)/(?P<questionpaper_id>\d+)/(?P<course_id>\d+)/$',
        views.skip),
    url(r'^enroll_request/(?P<course_id>\d+)/$',
        views.enroll_request, name='enroll_request'),
    url(r'^self_enroll/(?P<course_id>\d+)/$',
        views.self_enroll, name='self_enroll'),
    ...
    url(r'manage/edit_course/(?P<course_id>\d+)$',
        views.add_course, name='edit_course'),
    url(r'manage/course_detail/(?P<course_id>\d+)/$',
    ...
    url(r'manage/upload_users/(?P<course_id>\d+)/$',
        views.upload_users, name="upload_users"),
    url(r'manage/send_mail/(?P<course_id>\d+)/$',
    ...
    url(r'^manage/enroll/(?P<course_id>\d+)/$',
        views.enroll, name="enroll_users"),
    ...
    url(r'^manage/addteacher/(?P<course_id>\d+)/$',
        views.add_teacher, name='add_teacher'),
    url(r'^manage/remove_teachers/(?P<course_id>\d+)/$',
        views.remove_teachers, name='remove_teacher'),
